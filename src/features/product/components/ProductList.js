...
const sortOptions = [
  { name: "Best Rating", sort: "ratibng", order:"desc", current: false },
...
const filters = [
  {
    ...
    options: [
      ...
      { value: "Huewei", label: "Huewei", checked: false },
      ...
      { value: "Fogg Scent Expressio", label: "Fogg Scent Expressio", checked: false },
      { value: "L'Oreal Paris", label: "L'Oreal Paris", checked: false },
      { value: "Hemani Tea", label: "Hemani Tea", checked: false },
      { value: "Dermive", label: "Dermive", checked: false },
      { value: "Fair & Clear", label: "fair & Clear", checked: false },
      { value: "Baking soda", label: "Baking soda", checked: false },
      { value: "Dry Rose", label: "Dry Rose", checked: false },
      { value: "Decor", label: "Decor", checked: false },
      { value: "LED Lights", label: "LED Lights", checked: false },
      { value: "purpl", label: "Golden", checked: false },
    ],
  },
  {
    id: "category",
...
export default function ProductList() {
  ...
  //fetch all the products using dispatch 
  useEffect(() => {
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                          {products.map((product) => (
                            <Link to="/product-detail">
                              <div key={product.id} className="group relative p-3 border-solid border-2 border-gray-200  ">
                                <div className="min-h-60aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-60">
                                  <img
                                ...
                                <div className="mt-4 flex justify-between">
                                  <div>
                                    ...
                                    <span className="align-bottom">{product.rating}
                                    </span>
                                    </p>
                                  </div>
                                  <div>
